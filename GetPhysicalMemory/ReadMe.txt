========================================================================
    KONSOLENANWENDUNG: GetPhysicalMemory-Projektübersicht
========================================================================

Diese GetPhysicalMemory-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre GetPhysicalMemory-Anwendung besteht.


GetPhysicalMemory.vcxproj
...
GetPhysicalMemory.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen GetPhysicalMemory.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
